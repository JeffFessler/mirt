...
if nargin >= 1 && streq(yik, 'test')
	wmap = mri_field_map_pcg_ls_test(yik, varargin{:});
...
% mri_field_map_pcg_ls_test()
% built-in test/example, copied from mri_field_map_reg_test
function wmap = mri_field_map_pcg_ls_test(~, varargin)
...
[wmap, wconv] = mri_field_map_pcg_ls(yik, etime, 'l2b', -6, varargin{:});
